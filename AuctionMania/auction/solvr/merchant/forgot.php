...
if (isset($_POST['Login'])) {
   /* if (isset($_REQUEST['redirurl']))
        ...
        $url = "index.php";
*/
    $sql = mysqli_query($conn, "select * from march_register where email='" . $_POST["Username"] . "' and password='" . $_POST["Password"] . "'");
                    ...
                    <div class="w3_login_module">
                        <div class="module form-module">
                            ...
                            <div class="form">
                                ...
                                <form action="forgot_2.php"  name="form1">
                                    <input class="form-control" type="text" name="m" placeholder="Enter Mobile Number" required=" ">
