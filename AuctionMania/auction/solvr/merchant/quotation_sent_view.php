...
$mid=$_SESSION['mid'];
$sql = "SELECT * FROM vendor_confirm a, march_assign b where b.mid='$mid' AND a.cvid=b.cvid ";
			   ...
			   <td><?php echo $row['date']; ?></td>
			    <td><?php echo $row['qty_id']; ?></td>
				 <td><?php echo $row['uiid']; ?></td>
                  ...
                  <td>   
                  <a href="display_vendor_confirm.php?id=<?php echo $row['cvid'];   ?>" class="btn btn-app-mini">
