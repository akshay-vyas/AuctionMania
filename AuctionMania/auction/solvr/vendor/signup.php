...
if (isset($_POST['Register'])) {
    ...
    $addr = $_POST["f5"];
        ...
        if (!$conn) {
            ...
            $sql = "INSERT INTO vendor_request (name,email,phone,city,password)
VALUES ('$username','$Password','$Email','$usn','$addr')";
                           ...
                           <!--- <div class="toggle"><i class="fa fa-times fa-pencil"></i>
                            ...
                            <div class="form">
                                ...
                                <form action="#" method="post">
                                    ...
                                    <input class="form-control" type="password" name="f5"  placeholder="Password" required=" ">
