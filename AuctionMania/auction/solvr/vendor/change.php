...
$sql="select * from getin where email='$email'";
...
if(isset($_POST['add'])) {
	...
	if($new==$renew)
	{
		$query="update getin set password='$new' where email='$email'";
		  ...
		  <form action="" method="POST" enctype="multipart/form-data">
              <div class="box-body">
               <!--- <div class="form-group">
				...
				{
					?>
				<input type="hidden" name="id11" id="" value="<?php echo $row['email'];  ?>">
				<div class="form-group">
                  <label for="cat_img"> OLD PASSWORD</label>
                  <input type="password" readonly="true" class="form-control" name="name" id="" value="dumppassword" >
                </div>
				
				<div class="form-group">
                  <label for="cat_img">New Password</label>
                  <input type="text" class="form-control" name="new" id="" value="" >
                </div>
				
				<div class="form-group">
                  <label for="cat_img">Re Enter Password</label>
                  <input type="text" class="form-control" name="renew" id="" value="" >
                </div>
