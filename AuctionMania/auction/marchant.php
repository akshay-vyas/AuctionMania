...
if(isset($_POST['add']))
{
	...
	if($password==$cpassword)
	{
		...
		if($temp==0)
		{
			$sql1="insert into march_reg values(null,'$name','$company','$phone','$city','$email','dump')";
			$res1=mysqli_query($conn,$sql1);
		    $sql2="insert into getin values(null,'$email','$password','$question','$answer','merchant')";
	...
	<div class="about-bottom main-agile book-form">
		...
		<form action="#" method="post">
			<div class="form-date-w3-agileits">
				...
				<label> Company </label>
				<input type="text" name="company" placeholder="Your Name" required="">
				<label> Phone </label>
