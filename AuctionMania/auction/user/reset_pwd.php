...
if(isset($_POST['add'])) {
  ...
  $sql1="update user set pwd='$new' where email='$user' and pwd='$current'";
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
              ...
              <div class="box-body" style="box-shadow: 0 8px 12px 1px #888888;">
               <!--- <div class="form-group">
				...
				<div class="form-group">
                  ...
                  <input type="password" class="form-control"  name="cp" id="" placeholder="Enter Current Password">
                </div>
	...
	<div class="form-group">
                  ...
                  <input type="password" class="form-control" name="np" id="" placeholder="Enter New Password">
                </div>				
	...
	<div class="form-group">
                  ...
                  <input type="password" class="form-control" name="rp" id="" placeholder="Re Enter New Password">
                </div>	
