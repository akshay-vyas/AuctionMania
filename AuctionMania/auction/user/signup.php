...
if (isset($_POST['Register'])) {
    ...
    $city = $_POST["f6"];
        ...
        if (!$conn) {
            ...
            $sql = "INSERT INTO march_register (name,company,phone,city,email,password)
VALUES ('$username','$Password','$Email','$usn','$addr','$city')";
                    ...
                    <div class="w3_login_module">
                        <div class="module form-module">
                           <!--- <div class="toggle"><i class="fa fa-times fa-pencil"></i>
                            ...
                            <a href="index.php" style="float:right;text-decoration:underline;">Sign In</a>
                            <div class="form">
                                <h2>Create an account</h2>
                                <form action="#" method="post">
								    
                                    <input class="form-control" type="text" name="f1"  placeholder="Name(6-20 characters)" required=" ">
                                    <input class="form-control" type="text" name="f2"  placeholder="Company Name" required=" ">
									<input class="form-control" type="text" name="f3"  placeholder="Mobile Number" required=" ">
									  <input class="form-control" type="text" name="f4"  placeholder="City" required=" ">
                                    <input class="form-control" type="email" name="f5" placeholder="Email Address" required=" ">
									
                                    
                                    <input class="form-control" type="password" name="f6"  placeholder="Password" required=" ">
