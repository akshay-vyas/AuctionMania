            ...
            <ul class="dropdown-menu" style="box-shadow: 0 8px 12px 3px #888888;">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>USER ID is <?php  echo $_SESSION['uid']; ?> </small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
                <div class="row" >
                  <div class="col-xs-4 text-center">
                    <a href="user-sell.php">VERIFY</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="user-view.php">USERS</a>
                  </div>
                  <div class="col-xs-4 text-center">
      ...
      <ul class="sidebar-menu">
		...
		<li>
          <a href="user-sell.php">
            <i class="fa fa-th-large"></i> <span>VERIFY</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
		...
		<li>
          <a href="winner.php">
            <i class="fa fa-th-large"></i> <span>WINNERS</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
