...
//echo $sql;
		  while($row=mysqli_fetch_assoc($res))
		  {
            ...
            <div class="box-body box-profile">
              ...
              <h3 class="profile-username text-center"><?php echo $row['uname']; ?></h3>
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <b>Phone</b> <a class="pull-right"><?php echo $row['contact'];?></a>
                </li>
				
                
              </ul>

              <a href="profile_edit.php?id=<?php echo $row['uid'];?> " class="btn btn-primary btn-block"><b>Edit Profile</b></a>
            </div>
			<?php
		  }
		  ?>
