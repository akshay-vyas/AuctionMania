...
$cat_id=$_GET['id'];
$sql="select * from user where uid='$cat_id'";
...
if(isset($_POST['add'])) {
	...
	$query="update user set uname='$f1', contact='$f3', address='$f4' where uid='$del'";
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
		  ...
		  <form action="" method="POST" enctype="multipart/form-data">
              <div class="box-body" style="box-shadow: 0 8px 12px 1px #888888;">
               <!--- <div class="form-group">
				...
				<input type="hidden" name="id11" id="" readonly="true" value="<?php echo $row['uid'];  ?>">
				<div class="form-group">
                  <label for="cat_img">NAME</label>
                  <input type="text" class="form-control"  name="f1" id="" value="<?php echo $row['uname'];  ?>">
                </div>
	...
	<div class="form-group">
                  ...
                  <input type="text" class="form-control" name="f3" id="" value="<?php echo $row['contact'];  ?>">
                </div>				
	...
	<div class="form-group">
                  ...
                  <input type="text" class="form-control" name="f4" id="" value="<?php echo $row['address'];  ?>">
                </div>	

<input type="hidden" readonly="true" name="password" id="" value="<?php echo $row['pwd'];  ?>">
